          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className={`cursor-pointer flex-1 border border-zinc-300 py-3 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 transition ${inWishlist ? 'bg-red-100 text-red-600 hover:bg-red-200' : 'hover:bg-zinc-100 text-zinc-700 cursor-pointer '
                  }`}
              >
                {inWishlist ? (
                  <>

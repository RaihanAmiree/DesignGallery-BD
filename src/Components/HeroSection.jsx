...
<h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[1.1] lg:leading-[0.85] mb-6">
        ...
        <div className="relative flex justify-center items-center h-[350px] sm:h-[450px] lg:h-[500px] order-1 lg:order-2">
          ...
          >
             ...
             <div className="mt-auto">
               <div className="w-10 h-10 bg-[#00d4ff]/20 rounded-full mb-4 blur-md animate-pulse" />
               {/* <img src="/Products_Img/Jewel.png" alt="" /> */}
          ...
          {/* Glow effect - Hidden on very small screens to improve performance */}
          <motion.div 
            style={{ 
      ...
      {/* Side Decoration - Hidden on Mobile/Tablets */}
